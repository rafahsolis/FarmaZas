...
class Parafarmaciafrias_sp1(Spider):
    # ** DEFINICION DE VARIABLES **
    name = "FarmaciaFriasSp1" #@WARNING: Nombre de la arana para scrapy
    ...
    list_xpath= {'categoryname': '//*[@id="categories_block_left"]/div/ul/li', #menu completo de lis de las categorias
                 'subcategory': 'ul/li', #grupo de lis que comforman subcategorias dentro del li de la categoria
                 'suburl': 'a/@href',
                 'subname': 'a/text()',
                 'product': '//*[@id="product_list"]/li', #listado completo de lis de productos de una pagina de una categoria
                 'parent': 'a/text()',
                 'productcategory':'//h3[@class="category-title"]'} #nombre de la categoria cuando navegas por subcategorias. suelen ser breadcrumb o h1,h2,h3...
    ...
    ProductItem_fields = {'name' : 'div[@class="center_block"]/a/@title',
                          ...
                          'categoryname': 'div[@class="breadcrumb"]/a[1]/text()',
                          'subcategory': 'div[@class="breadcrumb"]/span[1]/text()',
    ...
    def parse_categoria(self, response):
        ...
        next = cat_sel.xpath('//div[@id="center_column"]/div[@class="content_sortPagiBar"]/div[@id="pagination_bottom"]/ul/li[@class="pagination_next"]/a/@href').extract()
        if next:
            yield scrapy.Request('http://www.farmacia-frias.com' + next[0], callback=self.parse_categoria)
